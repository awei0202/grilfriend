...
$appId = 'wx87f65adbc51e5192'; //对应自己的appId
$appSecret = '4c5f2446e7f8ac47d81ff46a4f88bca8'; //对应自己的appSecret
...
$tianqiurl = 'https://www.yiketianqi.com/free/day?appid=95943915&appsecret=5KNSKu9y&unescape=1&city=杭州'; //修改为自己的
...
$touser = 'otVYX6O2hGtsLG8yH_ZeS4onKp5M;  //这个填你女朋友的openid
$data = array(
    'touser' => $touser,
    'template_id' => "5xKVqk4gpmU_yWVuSuDaIv1QPBoiebQH1el4zSQjnF0", //改成自己的模板id，在微信后台模板消息里查看
    'data' => array(
        'first' => array(
            'value' => "$yjh",
            'color' => "#000"
